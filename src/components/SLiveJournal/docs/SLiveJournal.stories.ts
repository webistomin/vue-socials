...
const Template: Story<TBaseSocialPropsOptions<ISLiveJournalShareOptions>> = (_args, { argTypes }) => ({
  ...
  template: `
    <s-live-journal
      ...
      @popup-focus="onFocus"
    >
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 304.999 304.999">
