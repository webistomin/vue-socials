...
<Meta title='Share/SBlogger' component={ SBlogger } />
...
<Preview className="custom-preview">
  <Story id='share-sblogger--default' />
</Preview>
...
`shareOptions` | `object` | Your share link parameters: <br /> **url** – the URL you want to share <br /> **title** – your blogpost title  <br /> **text** – your blogpost content <br /> | `{}`
